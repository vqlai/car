...
<template>
    ...
    <el-row type="flex" class="top-btns">
      ...
      <el-col :span="2" :offset="22"><el-button type="primary" icon="el-icon-plus" @click="onAddChargeClick">新增</el-button></el-col>
...
export default {
  ...
  methods:{
    ...
    onCurrentChange(page){
      if(!this.pageFlag){
        this.pageFlag = true
        this._getCharge({page: page, page_size: this.pageSize})
      }
    },
