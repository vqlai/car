  ...
  children: [
    {
      ...
      name: 'insurance',
      meta:{title: '保险管理'},
      component: _import('drive/insurance/insurance')
    },{
      path: 'maintain',
      name: 'maintain',
      meta:{title: '保养管理'},
      component: _import('drive/maintain/maintain')
    },{
      path: 'illegal',
      name: 'illegal',
      meta:{title: '违章查询'},
      component: _import('drive/illegal/illegal')
    },{
      path: 'accident',
      name: 'accident',
      meta:{title: '事故管理'},
      component: _import('drive/accident/accident')
    }
  ]
}
// 运营管理路由
export const operationRouter = {
  ...
  children: [
    ...
    // },
    {
      ...
      name: 'warning',
         meta:{title: '报警信息'},
      component: _import('operation/warning/warning')
    },
  ]
}
// 车务管理路由
  ...
  children: [
    {
      ...
      name: 'check',
      meta:{title: '年检管理'},
      component: _import('traffic/check/check')
    },{
      path: 'fix',
      name: 'fix',
      meta:{title: '维修记录'},
      component: _import('traffic/fix/fix')
    },{
      path: 'mileage',
      name: 'mileage',
      meta:{title: '里程校正'},
      component: _import('traffic/mileage/mileage')
    }
    // ,{
    //   path: 'count',
    //   name: 'count',
