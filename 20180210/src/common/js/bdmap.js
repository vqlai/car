 ...
 * @returns 无返回
 */
export function addMapOverlay(longitude,latitude) {
...
function getInfoWindowHtml(obj){
  ...
  let time = obj.modify_time ? obj.modify_time : ''
  let speed = obj.latest_location.speed ? obj.latest_location.speed.toFixed(2) : 0
  let direction = obj.latest_location.direction ? getDirection(obj.latest_location.direction) : ''
