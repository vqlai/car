      ...
      <el-dialog :title="dialogType === 1 ? '新增车辆绑定':'编辑车辆绑定'" :visible.sync="carBindDialog" model="right" width="40%" @close="closeCarBindDialog">
        <el-form :model="formData" label-width="100px" :rules="formRules" ref="carBindForm">
          <el-form-item label="车牌号" prop="vehicle_number">
            <el-input v-model="formData.vehicle_number" auto-complete="off"></el-input>
          </el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <img :src="'//iotsvr.he-live.com:8002/'+scope.row.brand_logo" alt="汽车品牌" class="brand-img" v-if="scope.row.brand_logo">
...
export default {
  ...
  data () {
    return {
      ...
      uploadPath: `//iotsvr.he-live.com:8002/car/add`, // 图片上传路径
  ...
  methods:{
    ...
    onAddClick(){
      ...
      this.uploadPath= `//iotsvr.he-live.com:8002/car/add`
    },
    // 搜索
    onSearchClick(){
    ...
    onEditClick(row){
      ...
      this.uploadPath= `//iotsvr.he-live.com:8002/car/update`
    },
    // 窗口关闭重置窗口
    closeCarBindDialog(){
