...
export function getInfoWindow(obj){
  let opts = {
    ...
    height: 260,     // 信息窗口高度
    // title : `<div id="map-title">设备编号</div>`, // 信息窗口标题
 ...
 * @returns html模版
 */
export function getInfoWindowHtml(obj){
  // let time = obj.update_time ? moment.unix(obj.update_time/1000).format('YYYY-MM-DD HH:mm') : '-'
  let time = obj.pos_update_time ? obj.pos_update_time : '-'
  let speed = obj.speed
          ...
          <ul class="content">
            ...
            <li class="clearfix">
              <div class='left position'>
                <span>经纬度</span>
                <span>${obj.longitude},${obj.latitude}</span>
              </div>
            </li>
            <li class="clearfix">
              <div class='left position'>
