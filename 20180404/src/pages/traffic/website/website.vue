...
<template>
	<section class="website main-panel">
		<searchBox queryTip="请输入网点名称或地址" :addBtn="true" @onSearch="onSearchClick" @onAdd="onAddWebsiteClick"></searchBox>
