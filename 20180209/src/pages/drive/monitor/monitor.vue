      ...
      <el-aside width="320px">
        <el-tabs type="border-card">
          <el-tab-pane label="车辆列表">
            <deviceTable :showSelection="true" @onDeviveTableCellClick="onDeviveTableCellClick" @onDeviveTableSelection="onDeviveTableSelection"></deviceTable>
          </el-tab-pane>
        </el-tabs>
      </el-aside>
    </el-container>
...
export default {
  ...
  methods:{
    ...
    loadMapDialog(row){
      ...
      formatLngLat(row.latest_location.longitude,row.latest_location.latitude).then(res => {
        // console.log(res)
        row.address = res
        // 默认点击单元格弹窗
