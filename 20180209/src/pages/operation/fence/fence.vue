        ...
        <el-aside width="320px">
          <el-tabs type="border-card" @tab-click="onTabClick" value="fence">
            ...
            <el-tab-pane label="行政区域" name="area">
              <areaTree v-if="areaTree" @onTreeNodeClick="onTreeNodeClick"></areaTree>
            </el-tab-pane>
...
<script>
import {addMapOverlay, getCircle, getPolygon, getBound} from '@/common/js/bdmap'
import mapPanel from '@/components/map-panel'
import deviceTable from '@/components/device-table'
import areaTree from '@/components/area-tree'
import fenceTable from '@/components/fence-table'
import {createFence} from '@/api/operation'
